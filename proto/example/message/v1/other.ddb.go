...
// file_example_message_v1_other_proto_marshal_dynamo_item unmarshals DynamoDB attribute value maps into structpb.Value
func file_example_message_v1_other_proto_unmarshal_dynamo_structpb(m types.AttributeValue) (sv *structpb.Value, err error) {
	var vv any
	switch m.(type) {
