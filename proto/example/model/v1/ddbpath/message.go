...
// Package modelv1ddbpath holds generated code for working with Dynamo document paths
package modelv1ddbpath
...
// ThreadPath allows for constructing type-safe expression names
type ThreadPath struct {
	expression.NameBuilder
}

// WithDynamoNameBuilder allows generic types to overwrite the path
func (p ThreadPath) WithDynamoNameBuilder(n expression.NameBuilder) ThreadPath {
	p.NameBuilder = n
	return p
}

// ForumName appends the path being build
func (p ThreadPath) ForumName() expression.NameBuilder {
	return p.AppendName(expression.Name("1"))
}

// Subject appends the path being build
func (p ThreadPath) Subject() expression.NameBuilder {
	return p.AppendName(expression.Name("2"))
}

// LastPostDateTime appends the path being build
func (p ThreadPath) LastPostDateTime() expression.NameBuilder {
	return p.AppendName(expression.Name("3"))
}

// Replies appends the path being build
func (p ThreadPath) Replies() expression.NameBuilder {
	return p.AppendName(expression.Name("4"))
}
func init() {
	ddbpath.Register(ThreadPath{}, map[string]ddbpath.FieldInfo{
		"1": {Kind: ddbpath.FieldKindSingle},
		"2": {Kind: ddbpath.FieldKindSingle},
		"3": {Kind: ddbpath.FieldKindSingle},
		"4": {Kind: ddbpath.FieldKindSingle},
...
// ThreadPartitionKey returns a key builder for the partition key
func ThreadPartitionKey() (v expression.KeyBuilder) {
	return expression.Key("1")
}

// ThreadPartitionKeyName returns a name builder for the partition key
func ThreadPartitionKeyName() (v expression.NameBuilder) {
	return expression.Name("1")
}

// Thread returns a key builder for the partition key
func Thread() ThreadPath {
	return ThreadPath{}
}

// ThreadSortKey returns a key builder for the sort key
func ThreadSortKey() (v expression.KeyBuilder) {
	return expression.Key("2")
}

// ThreadSortKeyName returns a name builder for the sort key
func ThreadSortKeyName() (v expression.NameBuilder) {
	return expression.Name("2")
}

// ThreadKeyNames returns the attribute names of the partition and sort keys respectively
func ThreadKeyNames() (v []string) {
	v = append(v, "1")
	v = append(v, "2")
	return
}

// GameScorePath allows for constructing type-safe expression names
type GameScorePath struct {
	expression.NameBuilder
}

// WithDynamoNameBuilder allows generic types to overwrite the path
func (p GameScorePath) WithDynamoNameBuilder(n expression.NameBuilder) GameScorePath {
	p.NameBuilder = n
	return p
}

// UserId appends the path being build
func (p GameScorePath) UserId() expression.NameBuilder {
	return p.AppendName(expression.Name("1"))
}

// GameTitle appends the path being build
func (p GameScorePath) GameTitle() expression.NameBuilder {
	return p.AppendName(expression.Name("2"))
}

// TopScore appends the path being build
func (p GameScorePath) TopScore() expression.NameBuilder {
	return p.AppendName(expression.Name("3"))
}

// TopScoreDateTime appends the path being build
func (p GameScorePath) TopScoreDateTime() expression.NameBuilder {
	return p.AppendName(expression.Name("4"))
}

// Wins appends the path being build
func (p GameScorePath) Wins() expression.NameBuilder {
	return p.AppendName(expression.Name("5"))
}

// Losses appends the path being build
func (p GameScorePath) Losses() expression.NameBuilder {
	return p.AppendName(expression.Name("6"))
}
func init() {
	ddbpath.Register(GameScorePath{}, map[string]ddbpath.FieldInfo{
		"1": {Kind: ddbpath.FieldKindSingle},
		"2": {Kind: ddbpath.FieldKindSingle},
		"3": {Kind: ddbpath.FieldKindSingle},
		"4": {Kind: ddbpath.FieldKindSingle},
...
// GameScorePartitionKey returns a key builder for the partition key
func GameScorePartitionKey() (v expression.KeyBuilder) {
	return expression.Key("1")
}

// GameScorePartitionKeyName returns a name builder for the partition key
func GameScorePartitionKeyName() (v expression.NameBuilder) {
	return expression.Name("1")
}

// GameScore returns a key builder for the partition key
func GameScore() GameScorePath {
	return GameScorePath{}
}

// GameScoreSortKey returns a key builder for the sort key
func GameScoreSortKey() (v expression.KeyBuilder) {
	return expression.Key("2")
}

// GameScoreSortKeyName returns a name builder for the sort key
func GameScoreSortKeyName() (v expression.NameBuilder) {
	return expression.Name("2")
}

// GameScoreKeyNames returns the attribute names of the partition and sort keys respectively
func GameScoreKeyNames() (v []string) {
	v = append(v, "1")
	v = append(v, "2")
	return
}
