...
func (tg *Target) Generate(w io.Writer) error {
	...
	tg.idents.marshal, tg.idents.unmarshal, tg.idents.structunmarshal =
		...
		fmt.Sprintf("%s_unmarshal_dynamo_structpb", strings.ToLower(tg.src.GoDescriptorIdent.GoName))
